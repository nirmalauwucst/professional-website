          ...
          >
            <div className="max-w-lg">
              ...
              <p className="text-lg text-gray-700 mb-8">
                I design and develop applications that help businesses grow and
                users succeed. Passionate about clean code, user experience, and
              ...
              <div className="flex items-center space-x-6 mt-12">
                <a
                  href="#"
                  className="text-gray-600 hover:text-secondary text-2xl transition-colors"
                >
          ...
          >
            <div className="relative">
              ...
              <img
                ...
                alt="Nirmala Madusanka - Professional portrait"
