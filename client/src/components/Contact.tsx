        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-secondary hover:bg-blue-600 text-white py-6 h-auto px-6 rounded-lg font-medium transition-all flex items-center justify-center hover:-translate-y-1 hover:shadow-md"
          ...
          >
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <Button 
                className="w-full bg-accent hover:bg-green-600 text-white py-6 h-auto px-6 rounded-lg font-medium transition-all flex items-center justify-center hover:-translate-y-1 hover:shadow-md"
              >
